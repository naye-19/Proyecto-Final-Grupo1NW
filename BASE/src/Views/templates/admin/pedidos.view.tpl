<section class="container-fluid min-vh-100">
    ...
    <h3 class="my-4 text-center h1 font-weight-bold">Gestión de Pedidos Pendientes</h3>
        ...
        <tbody>
            ...
            <tr>
                ...
                <form action="index.php" method="get">
                    ...
                    <button type="submit" class="btn btn-outline-success my-1">Cambiar Estado</button>
                </form>
                </td>
            </tr>
            {{endfor items}}
